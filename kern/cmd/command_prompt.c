...
/**
 * checks if sub's chars exists in the original in the same order, i.e. sub is a subsequence of orig.
...
int is_subseq(char* sub, char* orig) {
	...
	/**
	 * Iterates over the original string and increments the found counter on a character match
	 *
...
{
	//TODO: [PROJECT'24.MS1 - #01] [1] PLAY WITH CODE! - process_command [DONE]
